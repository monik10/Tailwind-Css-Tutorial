...
const Footer = () => {
  return (
    <div className="w-5/6 mx-auto my-10" id="about">
  ...
  <div className="max-w-screen-xl px-4 mx-auto">
    ...
    <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
      <form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
        ...
        <button
          className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-green-400 rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-purple-200"
          type="submit"
        >
          Subscribe
        </button>
    ...
    <div className="text-center text-gray-600 dark:text-gray-200 pt-10 sm:pt-12 font-normal flex items-center justify-center">
